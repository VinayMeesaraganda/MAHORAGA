...
8. [Guidance-continuation implementation status](guidance-continuation-status.md): original shadow pipeline, operating commands and dedicated paper-pilot follow-up. Supersedes earlier setup claims where explicitly noted.
...
10. [Three-strategy operation](multi-strategy-operation.md): dedicated Workers, deterministic strategies, Finnhub, risk controls, commands, paper activation and remaining data/fill-validation requirements.
